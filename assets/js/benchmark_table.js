...
var chartFormatter = function (cell, formatterParams, onRendered) {
    ...
    const rowData = cell.getRow().getData(); // <<< Get row data to access subject scores
